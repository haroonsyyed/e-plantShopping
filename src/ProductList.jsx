...
function ProductList() {
    ...
    // Get cart items from Redux store and compute total quantity
   ...
   const styleA={
    ...
    // Handler: add a plant to cart, dispatch Redux action and mark as added
    ...
    // Handler: show cart view, hide products
    ...
    // Handler: show products view, hide cart
    ...
    // Callback passed to CartItem to return to product grid
